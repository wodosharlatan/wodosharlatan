...
async function generateReadMe() {
  ...
  const userData = await fetch("https://api.github.com/users/wodosharlatan").then(res => res.json());

  // Update DATA object with fetched user data
  const DATA = {
    name: userData.name,
  ...
  // Render Mustache template with updated DATA object
